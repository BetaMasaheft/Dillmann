...
<html>
    ...
    <h1 style="text-align: center; ">Are you really sure you want to delete <strong>{$form}</strong>?</h1>
        <a role="button" style="margin-bottom:4px; word-wrap:break-word; white-space:normal;" class="col-md-6 btn btn-danger" href="/Dillmann/edit/delete.xq?id={$id}">Yes. Delete it with no mercy (but make a backup).</a>
        
        <a  role="button" style="margin-botto:4px; word-wrap:break-word; white-space:normal;" class="col-md-6 btn btn-success" href="/Dillmann/lemma/{$id}">No!!! I hit the red trash button by mistake! Take me back...</a>
   </div>
   </body>
</html>
