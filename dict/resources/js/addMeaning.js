$(document).ready(function() {
    ...
    var place         = $("#addsense"); //Fields wrapper
    ...
    var divgroups = "<div> \
       ...
       $(place).append('<div>' + divgroups + '<a href="#" class="btn btn-danger remove_field btn-xs">Remove ' + language +' meaning permanently</a></div>'); //add input box
